          ...
          <div className="card style">
            <div className="card-body">
              ...
              <p className="card-text">
                Provide us with the inintial information about your project e.g
                farm give us your contact.
              </p>
            </div>
          </div>
          ...
          <div className="card style">
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                the requirements by the professionals,investors and farmer your
                self.
              </p>
            </div>
          </div>
