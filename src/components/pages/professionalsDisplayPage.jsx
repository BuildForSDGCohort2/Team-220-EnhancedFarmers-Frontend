...
import { getAllProfessionals, deleteProfessional } from "../../services/professionals";
   ...
   columns = [
     {
       path: "name",
       label: "Name",
       content: (professional) => <Link to={`/professional/${professional.id}`}>{professional.name}</Link>
     },
   ...
   render() {
     return (
       <div className="container">
         <Link className="btn btn-primary" to="/professionals/signup">create professional</Link>
         {this.renderTable()}
       </div>
     );
   }
